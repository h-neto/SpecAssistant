...
import pt.haslab.specassistant.runtime.util.Ordered;
...
public class PolicyManager {
    ...
    public void computePolicyForGraph(ObjectId graph_id, PolicyOption policyOption) {
        ...
        Dijkstra(graph_id, policyOption);
    ...
    public void Dijkstra(ObjectId graph_id, PolicyOption policyOption) {
        ...
        Function<List<Double>, Double> chosenOne = switch (policyOption.getObjective()) {
        ...
        while (!batch.isEmpty()) {
            ...
            Double target = chosenOne.apply(scores);
