...
import pt.haslab.specassistant.runtime.data.models.Model;
...
import static pt.haslab.specassistant.runtime.util.Text.secretPos;
...
public class GraphManager {
    ...
    public Set<ObjectId> getModelGraphs(String model_id) {
        return challengeRepo.streamByModelId(model_id).map(Challenge::getGraph_id).collect(Collectors.toSet());
    }
